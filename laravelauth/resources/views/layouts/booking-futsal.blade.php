...
<link rel="stylesheet" href="/css/box-input.css">
...
<div class="header-futsalprima">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            {{-- <li class="mr-3">
              <a class="inline-block py-2 px-4 text-black font-bold no-underline hover:text-gray-800 hover: text-underline py-2 px-4" href="/profile">Profil Futsal Prima</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-black no-underline font-bold hover:text-gray-800 hover: text-underline py-2 px-4" href="/booking">Booking</a>
            </li> --}}
             <li class="mr-3">
